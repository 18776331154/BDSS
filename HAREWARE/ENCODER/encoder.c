...
void encoder_caculter(ENCODER_T * encoder_n)
{
		...
		ENCODER_T *encoder=(ENCODER_T *)encoder_n;
		encoder->angle=(short)TIM3 -> CNT;
		
		encoder->angle_speed=encoder->angle-encoder->angle_last;
		encoder->angle_acceleration=encoder->angle_speed-encoder->angle_speed_last;
